...
use zenoh::shm::{
    ProtocolID, ShmClient, ShmClientStorage, GLOBAL_CLIENT_STORAGE,
};
...
use crate::{
    ...
    z_loaned_shm_client_storage_t, z_owned_shm_client_storage_t,
...
#[no_mangle]
pub extern "C" fn zc_shm_client_list_null(
    this: *mut MaybeUninit<zc_owned_shm_client_list_t>,
) {
...
#[no_mangle]
pub extern "C" fn zc_shm_client_list_check(
...
#[no_mangle]
pub extern "C" fn zc_shm_client_list_drop(
...
#[no_mangle]
pub extern "C" fn z_shm_client_storage_null(
    this: *mut MaybeUninit<z_owned_shm_client_storage_t>,
) {
    Inplace::empty(this.transmute_uninit_ptr());
}
...
/// Returns ``true`` if `this` is valid.
#[no_mangle]
pub extern "C" fn z_shm_client_storage_check(
...
#[no_mangle]
pub extern "C" fn z_shm_client_storage_drop(
