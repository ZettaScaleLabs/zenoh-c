...
use zenoh::shm::{
    ...
    ShmProvider, ShmProviderBuilder,
};
...
use crate::{
    ...
    z_loaned_shm_provider_t, z_owned_buf_alloc_result_t,
    z_owned_shm_provider_t, z_owned_shm_mut_t,
};

use super::{
    chunk::z_allocated_chunk_t,
    shm_provider_backend::{
        zc_shm_provider_backend_callbacks_t, DynamicShmProviderBackend,
    },
    shm_provider_impl::{
...
pub type DynamicShmProvider =
    ShmProvider<DynamicProtocolID, DynamicShmProviderBackend<Context>>;
...
#[no_mangle]
pub extern "C" fn z_shm_provider_null(
    this: *mut MaybeUninit<z_owned_shm_provider_t>,
) {
...
#[no_mangle]
pub extern "C" fn z_shm_provider_loan(
...
#[no_mangle]
pub extern "C" fn z_shm_provider_defragment(
    provider: &z_loaned_shm_provider_t,
) {
    defragment(provider);
}
...
#[no_mangle]
pub extern "C" fn z_shm_provider_garbage_collect(
    provider: &z_loaned_shm_provider_t,
) {
...
#[no_mangle]
pub extern "C" fn z_shm_provider_available(
    provider: &z_loaned_shm_provider_t,
) -> usize {
    available(provider)
}
